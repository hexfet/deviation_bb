...
//printf("prim 0x%02x, id 0x%02x\n", prim, id);
    ...
    case CURR_FIRST_ID & 0xfff0:
        ...
        set_telemetry(TELEM_FRSKY_DISCHARGE, Telemetry.value[TELEM_FRSKY_DISCHARGE] + data * (CLOCK_getms() - discharge_time) / 36000);
...
{0x0e, 0xa5, 0x8b, 0x02, 0x2d, 0x21, 0x06, 0x7e, 0x1a, 0x10, 0x00, 0x02, 0x7d, 0x05, 0x58, 0x90, 0x3c},
{0x0e, 0xa5, 0x8b, 0x02, 0xd7, 0x32, 0x06, 0x5e, 0x00, 0x00, 0x00, 0x1a, 0x10, 0xc6, 0x72, 0x05, 0x3c},
